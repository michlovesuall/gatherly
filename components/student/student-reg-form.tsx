...
export default function StudentRegistrationForm({
  ...
  const [colleges, setColleges] = useState<Array<{ collegeId: string; name: string; acronym: string }>>([]);
  const [departments, setDepartments] = useState<Array<{ departmentId: string; name: string; acronym: string; collegeId: string; collegeName: string }>>([]);
  const [programs, setPrograms] = useState<Array<{ programId: string; name: string; acronym: string; departmentId: string; departmentName: string; collegeId: string; collegeName: string }>>([]);
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="grid md:col-span-2 gap-2">
            ...
            <Select
              ...
              disabled={!institutionValue || loadingColleges || colleges.length === 0}
            >
              <SelectTrigger className="w-full">
                <SelectValue placeholder={loadingColleges ? "Loading colleges..." : !institutionValue ? "Select institution first" : colleges.length === 0 ? "No colleges available" : "Select College..."} />
              </SelectTrigger>
              <SelectContent>
                {colleges.length === 0 ? (
            ...
            {institutionValue && !loadingColleges && colleges.length === 0 && (
              <p className="text-xs text-amber-600">
                No colleges are available for this institution. Please contact your institution administrator.
              </p>
            )}
          </div>
          <div className="grid md:col-span-2 gap-4 md:grid-cols-2">
            <div className="grid gap-2">
              ...
              <Select
                ...
                disabled={!collegeId || loadingDepartments || filteredDepartments.length === 0}
              >
                <SelectTrigger className="w-full">
                  <SelectValue placeholder={loadingDepartments ? "Loading departments..." : !collegeId ? "Select college first" : filteredDepartments.length === 0 ? "No departments available" : "Select Department..."} />
                </SelectTrigger>
                <SelectContent>
              ...
              {collegeId && !loadingDepartments && filteredDepartments.length === 0 && (
                <p className="text-xs text-amber-600">
                  No departments are available for this college. Please contact your institution administrator.
                </p>
              )}
            </div>
            <div className="grid gap-2">
              ...
              <Select
                ...
                disabled={!departmentId || loadingPrograms || filteredPrograms.length === 0}
              >
                <SelectTrigger className="w-full">
                  <SelectValue placeholder={loadingPrograms ? "Loading programs..." : !departmentId ? "Select department first" : filteredPrograms.length === 0 ? "No programs available" : "Select Program..."} />
                </SelectTrigger>
                <SelectContent>
              ...
              {departmentId && !loadingPrograms && filteredPrograms.length === 0 && (
                <p className="text-xs text-amber-600">
                  No programs are available for this department. Please contact your institution administrator.
                </p>
              )}
            </div>
          </div>
